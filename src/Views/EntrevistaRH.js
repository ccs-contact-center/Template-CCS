                    ...
                    >
                      ...
                      <Row>
                        <Col className="col-sm-6">
                          <FormGroup>
                            <Label htmlFor="prospecto">¿Tiene Hijos?</Label>
                            <Input
                              type="select"
                              placeholder="Categoría"
                              required
                      ...
                      <Row>
                        <Col className="col-sm-4">
                          <FormGroup>
                            <Label htmlFor="prospecto">Status Entrevista</Label>
                            <Input
                              type="select"
                              placeholder="Categoría"
                              required
                              onChange={this.handleChange}
                              id="status_entrevista"
                              value={this.state.status_entrevista}
                            >
                              <option value="">-Selecciona-</option>
                        ...
                        <Col className="col-sm-4">
                          {this.state.status_entrevista === "" ? null : this
                              .state.status_entrevista === "3" ? (
                            <FormGroup>
                          ...
                          ) : this.state.status_entrevista === "1" ? (
                            <FormGroup>
                              ...
                              <Input
                                ...
                                onChange={this.handleChange}
                                id="motivo_rechazo"
                                value={this.state.motivo_rechazo}
                              >
                                <option value="">-Selecciona-</option>
                                <option>Perfil</option>
                                <option>No Reingreso</option>
                              </Input>
                            </FormGroup>
                          ) : this.state.status_entrevista === "2" ? (
                            <FormGroup>
                              <Label htmlFor="prospecto">Motivo</Label>
                              <Input
                                type="select"
                        ...
                        {this.state.status_entrevista === "3" ? (
                          <Col className="col-sm-4">
                            <FormGroup>
                              ...
                              <Input
                                ...
                                onChange={this.handleChange}
                                id="turno"
                                value={this.state.turno_prospecto}
                              >
                                <option value="">-Selecciona-</option>
                        ...
                        {this.state.motivo_rechazo === "Turno" ? (
                          <Col className="col-sm-4">
                            <FormGroup>
                              <Label htmlFor="prospecto">Requiere</Label>
                              <Input
                                type="select"
                                placeholder="Categoría"
                                required
                        ...
                        ) : this.state.motivo_rechazo === "Perfil" ? (
                          <Col className="col-sm-4">
                            <FormGroup>
                              <Label htmlFor="prospecto">Actual</Label>
                              <Input
                                type="select"
                                placeholder="Categoría"
                                required
                        ...
                        ) : this.state.motivo_rechazo === "Salario" ? (
                          <Col className="col-sm-4">
                            <FormGroup>
                              <Label htmlFor="prospecto">Requiere</Label>
                              <Input
